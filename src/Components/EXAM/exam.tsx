...
const Exam = () => {
    ...
    console.log(getMutualFriends({id: 1, name: "Bob"}, {id: 4, name: "Alex"}))
...
// }
//
// console.log(updateUserAddress(2, "country", "SPB" ))
// Дан список пользователей и структура, хранящая адреса пользователей.
...
// }
//
// console.log(updateCourseStatus(samuraiID_1, "HTML", false))
